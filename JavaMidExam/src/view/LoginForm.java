...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        if (loggedUser != null) {
            ...
            // ✅ NEW: if student, load student_id from students table
            if ("student".equalsIgnoreCase(loggedUser.getRole())) {
                dao.StudentDao sdao = new dao.StudentDao();
                Integer stuId = sdao.getStudentIdByUserId(loggedUser.getUserId());
                if (stuId != null) {
                    Session.currentStudentId = stuId;
                    System.out.println("Logged in student_id = " + stuId);
                } else {
                    JOptionPane.showMessageDialog(this, "Student record not found for this user!");
                }
            }

            JOptionPane.showMessageDialog(this, "Welcome " + loggedUser.getFullName() + "!");
